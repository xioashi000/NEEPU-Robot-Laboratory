...
void OLED_W_SCL(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_8, (GPIO_PinState)(BitValue ? GPIO_PIN_SET : GPIO_PIN_RESET));
...
void OLED_W_SDA(uint8_t BitValue)
{
	...
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_9, (GPIO_PinState)(BitValue ? GPIO_PIN_SET : GPIO_PIN_RESET));
