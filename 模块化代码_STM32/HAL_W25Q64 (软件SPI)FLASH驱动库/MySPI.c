...
{
    // 假设BitValue为0或1，分别代表低电平和高电平
    // 使用HAL_GPIO_WritePin函数来设置指定GPIO引脚的状态
...
{
    HAL_GPIO_WritePin(GPIOC, GPIO_PIN_3, (GPIO_PinState)BitValue);
}
...
{
    // 使用HAL_GPIO_ReadPin函数来读取指定GPIO引脚的状态
